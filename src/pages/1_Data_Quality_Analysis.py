...
def setup_sidebar():
    ...
    sidebar_col1, sidebar_col2 = st.sidebar.columns(2)
    # Gridlines selectbox
    select_grid = sidebar_col1.selectbox('**Gridlines**', grid_map.keys())
    grid = grid_map[select_grid]

    # Legend Location selectbox
    legend_location = sidebar_col2.selectbox('**Legend**', legend_locations).lower()
...
def setup_main_area(input_features):
    """
...
if __name__== '__main__':
    ...
    setup_main_area(input_features)
